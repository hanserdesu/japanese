...
[下载 WCP 日语词书一键安装包 v1.2.9.3](https://github.com/hanserdesu/japanese/releases/download/wcp-jp-v1.2.9.3/WCP-Japanese-OneClick-Installer-wcp-jp-v1.2.9.3.zip)（发布页：[wcp-jp-v1.2.9.3](https://github.com/hanserdesu/japanese/releases/tag/wcp-jp-v1.2.9.3)）。正在使用旧版本的用户直接覆盖安装一次即可；v1.2.7 起安装器自带自更新。本次更新日语小游戏发音路由和包内读音、释义解析；本版默认关闭向游戏共用目录复制单词音频，受管词发音由词书私有目录提供。
